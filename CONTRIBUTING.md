# Contributing to Keep Calm as a Service
...
The [issue tracker](https://github.com/EricMountain/KCaaS/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/KCaaS.git
   # Navigate to the newly cloned directory
   cd KCaaS
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/EricMountain/KCaaS.git
   ```
